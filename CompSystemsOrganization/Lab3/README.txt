...
To run: 
Compile pager.c then run the output file with 3 arguments: the page replacement poilcy (0 for FIFO, 1 for LRU, 2 for Random), the number of pages the memory can hold, and the memory access text file.
